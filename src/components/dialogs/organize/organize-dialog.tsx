  ...
  return (
    ...
    >
      ...
      <DialogContent className="max-w-3xl">
        ...
        >
          <div className="scrollbar flex max-h-[40rem] flex-col gap-3 overflow-y-auto sm:grid sm:grid-cols-2">
            <div className="flex flex-col items-center gap-2">
              <h3>{t('streams-subtitle')}</h3>
              {organizeState.streamers.length > 0 && (
                <ul className="scrollbar max-h-[17rem] w-full space-y-2 overflow-y-auto sm:max-h-none">
