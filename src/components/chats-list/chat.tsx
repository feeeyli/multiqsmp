...
export const Chat = (props: ChatProps) => {
  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-between gap-2 bg-muted/70 px-3 py-1 group-data-[collapsed=true]:h-full group-data-[collapsed=true]:flex-col-reverse group-data-[collapsed=true]:px-1 group-data-[collapsed=true]:py-3">
        <Button
